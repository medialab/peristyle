...
## Sommaire
 ...
 - [Les différentes normalisations](#les-différentes-normalisations)
 - [Features calculées avec des regex](#features-calculées-avec-des-regex)
  - [Explications](#explications)
  - [Features calculées](#features-calculées)
    - [negation_prop](#negation_prop)
    - [subjectivity_prop](#subjectivity_prop)
    - [interpellation_prop](#interpellation_prop)
    - [nous_prop](#nous_prop)
 - [Features calculées avec NLTK ](#features-calculées-avec-nltk)
    - [Features utilisant la tokenisation de nltk](#features-utilisant-la-tokenisation-de-nltk)
      - [nb_sent](#nb_sent)
      - [nb_char](#nb_char)
   ...
   - [Métrique de lisibilité ARI](#ari)
      - [Explication](#explications-ari)
      - [Formule](#formule-ari)
   - [Métrique de richesse de vocabulaire sttr](#sttr)
      - [Explications](#explications-sttr)
 - [Features calculées avec Spacy](#features-calculées-avec-spacy)
   - [Pos-tagging](#pos-tagging)
   - [Features calculées](#features-calculées-spacy)
      - [Features verbales](#features-verbales)
         - [verb_prop](#verb_prop)
      ...
      - [Features de ponctuation](#punct-features)
      ...
      - [Features grammaticales](#gram_features)
         ...
         - [pronp_prop](#pronp_p)
      - [Features d'entitées nommées](#ner-features)
         - [ner_prop](#ner_prop)
 ...
 - [Features calculées avec d'autres ressources de NLP](#nlp-features)
   - [Le repo NLP](#repo-nlp)
   - [Exceptions noms propres](#nom-propres)
      - [propernoun_prop](#propernoun_prop)
   - [Dictionnaire français](#français)
      - [dictwords_prop](#dictwords_prop)
   - [Dictionaire de stopwords](#stopwords)
      - [stopwords_prop](#stopwords_prop)
   - [wikitionary.csv](#wikitionary)
      - [level0_prop](#level0_porp)
      - [level2_prop](#level2_prop)
      - [autre_prop](#autre_prop)
      - [level1_prop](#level1_prop)
 - [Features biais](#features-biais)
   - [Explications](#explications-biais)
   - [Méthode de calcul](#biais-calcul)
...
## Les différentes normalisations<a name="les-différentes-normalisations"></a>
...
## Features calculées avec des regex<a name="features-calculées-avec-des-regex"></a>
...
### Features calculées<a name="features-calculées"></a>
...
## Features calculées avec NLTK<a name="features-calculées-avec-NLTK"></a>
...
### Features utilisant la tokenisation de nltk<a name="features-utilisant-la-tokenisation-de-nltk"></a>
...
### Métrique de lisibilité *ARI*<a name="ari"></a>
#### Explication<a name="explications-ari"></a>
...
#### Formule<a name="formule-ari"></a>
             ARI = 4.71 * (moyenne de charactères par mot) + 0.5 * (moyenne de mots par phrase) - 21.43

### Métrique de richesse de vocabulaire *sttr*<a name="sttr"></a>
#### Explications<a name="explications-sttr"></a>
...
## Features calculées avec Spacy<a name="features-calculées-avec-spacy"></a>
### Pos-tagging<a name="pos-tagging"></a>
...
### Features calculées<a name="features-calculées-spacy"></a>
#### Features verbales<a name="features-verbales"></a>
...
#### Features de ponctuation<a name="punct-features"></a>
...
#### Features grammaticales<a name="gram_features"></a>
...
#### Features d'entitées nommées<a name="ner-features"></a>
...
## Features calculées grâce à d'autres ressources NLP<a name="nlp-features"></a>
### Le repo NLP<a name="repo-nlp"></a>
...
### Exceptions noms propres<a name="nom-propres"></a>
...
### Dictionnaire français<a name="français"></a>
...
### Dictionaire de stopwords<a name="stopwords"></a>
...
### wikitionary.csv<a name="wikitionary"></a>
...
## Features biais<a name="features-biais"></a>
### Explications<a name="explications-biais"></a>
...
### Méthode de calcul<a name="biais-calcul"></a>
