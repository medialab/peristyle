  ...
  return (0, _helpers.deepMerge)(tests, {
    ...
    '#.getNodeAttribute': {
      ...
      'it should return the correct value.': function itShouldReturnTheCorrectValue() {
        ...
        _assert2.default.strictEqual(graph.getNodeAttribute('Martha', 'age'), 34);
      },
      ...
      'it should return undefined if the attribute does not exist.': function itShouldReturnUndefinedIfTheAttributeDoesNotExist() {
        ...
        _assert2.default.strictEqual(graph.getNodeAttribute('Martha', 'age'), undefined);
      }
    },
    ...
    '#.getEdgeAttribute': {
      ...
      'it should return the correct value.': function itShouldReturnTheCorrectValue() {
        ...
        var edge = graph.addEdge('John', 'Thomas', { weight: 2 });

        _assert2.default.strictEqual(graph.getEdgeAttribute(edge, 'weight'), 2);
        _assert2.default.strictEqual(graph.getEdgeAttribute('John', 'Thomas', 'weight'), 2);
      },
      ...
      'it should also work with typed edges.': function itShouldAlsoWorkWithTypedEdges() {
        ...
        _assert2.default.strictEqual(graph.getDirectedEdgeAttribute('John', 'Thomas', 'weight'), 2);
        _assert2.default.strictEqual(graph.getUndirectedEdgeAttribute('John', 'Thomas', 'weight'), 3);
      },
      ...
      'it should return undefined if the attribute does not exist.': function itShouldReturnUndefinedIfTheAttributeDoesNotExist() {
        ...
        _assert2.default.strictEqual(graph.getEdgeAttribute(edge, 'weight'), undefined);
      }
    },
    ...
    '#.getNodeAttributes': {
      ...
      'it should return the correct value.': function itShouldReturnTheCorrectValue() {
        ...
        _assert2.default.deepEqual(graph.getNodeAttributes('Martha'), { age: 34 });
      },
    ...
    '#.getEdgeAttributes': {
      ...
      'it should return the correct value.': function itShouldReturnTheCorrectValue() {
        ...
        _assert2.default.deepEqual(graph.getEdgeAttributes(edge), { weight: 2 });
        _assert2.default.deepEqual(graph.getEdgeAttributes('John', 'Thomas'), { weight: 2 });
      },
      ...
      'it should also work with typed edges.': function itShouldAlsoWorkWithTypedEdges() {
        ...
        _assert2.default.deepEqual(graph.getDirectedEdgeAttributes('John', 'Thomas', 'weight'), { weight: 2 });
        _assert2.default.deepEqual(graph.getUndirectedEdgeAttributes('John', 'Thomas', 'weight'), { weight: 3 });
      },
    ...
    '#.hasEdgeAttribute': {
      ...
      'it should also work with typed edges.': function itShouldAlsoWorkWithTypedEdges() {
        ...
        _assert2.default.strictEqual(graph.hasDirectedEdgeAttribute('John', 'Thomas', 'weight'), true);
        _assert2.default.strictEqual(graph.hasUndirectedEdgeAttribute('John', 'Thomas', 'weight'), false);
      },
    ...
    '#.setNodeAttribute': {
      ...
      'it should correctly set the node\'s attribute.': function itShouldCorrectlySetTheNodeSAttribute() {
        ...
        _assert2.default.strictEqual(graph.getNodeAttribute('John', 'age'), 45);
      }
    },
    ...
    '#.setEdgeAttribute': {
      'it should correctly set the edge\'s attribute.': function itShouldCorrectlySetTheEdgeSAttribute() {
        var graph = new Graph();
        graph.addNodesFrom(['John', 'Martha']);
        var edge = graph.addEdge('John', 'Martha', { weight: 3 });

        graph.setEdgeAttribute(edge, 'weight', 40);
        _assert2.default.strictEqual(graph.getEdgeAttribute(edge, 'weight'), 40);

        graph.setEdgeAttribute('John', 'Martha', 'weight', 60);
        _assert2.default.strictEqual(graph.getEdgeAttribute(edge, 'weight'), 60);
      },
    ...
    '#.updateNodeAttribute': {
      ...
      'it should correctly set the node\'s attribute.': function itShouldCorrectlySetTheNodeSAttribute() {
        ...
        _assert2.default.strictEqual(graph.getNodeAttribute('John', 'age'), 21);
      },
      ...
      'the given value should be undefined if not found.': function theGivenValueShouldBeUndefinedIfNotFound() {
        ...
        _assert2.default.strictEqual(graph.getNodeAttribute('John', 'age'), 10);
      }
    },
    ...
    '#.updateEdgeAttribute': {
      ...
      'it should correctly set the edge\'s attribute.': function itShouldCorrectlySetTheEdgeSAttribute() {
        ...
        _assert2.default.strictEqual(graph.getEdgeAttribute(edge, 'weight'), 4);

        graph.updateEdgeAttribute('John', 'Martha', 'weight', function (x) {
          return x + 2;
        });
        _assert2.default.strictEqual(graph.getEdgeAttribute(edge, 'weight'), 6);
      },
      ...
      'the given value should be undefined if not found.': function theGivenValueShouldBeUndefinedIfNotFound() {
        ...
        _assert2.default.strictEqual(graph.getEdgeAttribute(edge, 'weight'), 10);
      }
    },
    ...
    '#.removeEdgeAttribute': {
      ...
      'it should also work with typed edges.': function itShouldAlsoWorkWithTypedEdges() {
        ...
        _assert2.default.strictEqual(graph.hasDirectedEdgeAttribute('John', 'Thomas', 'weight'), false);
        _assert2.default.strictEqual(graph.hasUndirectedEdgeAttribute('John', 'Thomas', 'weight'), false);
      }
    },
    ...
    '#.replaceNodeAttributes': {
      ...
      'it should correctly replace attributes.': function itShouldCorrectlyReplaceAttributes() {
        ...
        _assert2.default.deepEqual(graph.getNodeAttributes('John'), { age: 23, eyes: 'blue' });
      }
    },
    ...
    '#.replaceEdgeAttributes': {
      ...
      'it should also work with typed edges.': function itShouldAlsoWorkWithTypedEdges() {
        ...
        _assert2.default.deepEqual(graph.getDirectedEdgeAttributes('John', 'Thomas'), { weight: 2 });
        _assert2.default.deepEqual(graph.getUndirectedEdgeAttributes('John', 'Thomas'), { weight: 3 });
      },

      'it should correctly replace attributes.': function itShouldCorrectlyReplaceAttributes() {
        var graph = new Graph();
        graph.addNodesFrom(['John', 'Martha']);
        var edge = graph.addEdge('John', 'Martha', { weight: 1 });

        graph.replaceEdgeAttributes(edge, { weight: 4, type: 'KNOWS' });

        _assert2.default.deepEqual(graph.getEdgeAttributes(edge), { weight: 4, type: 'KNOWS' });
      }
    },
    ...
    '#.mergeNodeAttributes': {
      ...
      'it should correctly merge attributes.': function itShouldCorrectlyMergeAttributes() {
        ...
        _assert2.default.deepEqual(graph.getNodeAttributes('John'), { age: 45, eyes: 'blue' });
      }
    },
    ...
    '#.mergeEdgeAttributes': {
      ...
      'it should also work with typed edges.': function itShouldAlsoWorkWithTypedEdges() {
        ...
        _assert2.default.deepEqual(graph.getDirectedEdgeAttributes('John', 'Thomas'), { weight: 2, test: 0 });
        _assert2.default.deepEqual(graph.getUndirectedEdgeAttributes('John', 'Thomas'), { weight: 3, test: 0 });
      },
      ...
      'it should correctly merge attributes.': function itShouldCorrectlyMergeAttributes() {
        ...
        _assert2.default.deepEqual(graph.getEdgeAttributes(edge), { weight: 1, type: 'KNOWS' });
      }
    }
  });
}